...
This design can be improved so i'm open to any new changes implemented.
...
## Setup
cap ~~For use with the professional version of Burp Suite.~~ Ensure you have JPython loaded and setup
before installing.
